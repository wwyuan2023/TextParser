...
def main():
    ...
    # parse arguments
    help_str = f"usage: text-pronunciation OPTIONS... [FILE]\n\n"
    help_str += f"Text pronunciation for Chinese or English segtext, version={__version__}\n\n"
    help_str += f"Print pronunciated results of lines from each FILE to standard output.\n"
    ...
    while i < len(sys.argv):
        ...
        if len(a) > 1 and a[0] == "-":
            if a == "-h" or a == "--help":
                ...
                print(f"text-pronunciation, version={__version__}"
